...
console.log(wormholeConfig);

const Connect = () => {
  const [wormholeConfig, setWormholeConfig] = useState({});

  console.log("Entering deployments.json");

  useEffect(() => console.log("Updated WH config", wormholeConfig), [wormholeConfig]);
