...
export const TxReceipt = ({ txResult }: { txResult: TransactionReceipt }) => {
  ...
  return (
    <div className="flex text-sm  peer-checked:rounded-b-none min-h-0 bg-secondary py-0">
      ...
      <div className="flex-wrap collapse collapse-arrow">
        ...
        <div className="collapse-content overflow-auto bg-secondary rounded-t-none  !pl-0">
